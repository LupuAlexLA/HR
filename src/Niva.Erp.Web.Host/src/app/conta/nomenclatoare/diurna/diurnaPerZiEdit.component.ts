...
@Component({
    templateUrl: './diurnaPerZiEdit.component.html',
    animations: [appModuleAnimation()]
})
export class DiurnaPerZiEditComponent extends AppComponentBase implements OnInit {
    ...
    ngOnInit() {
        ...
        this._diurnaService.getDiurnaZiById(this.diurnaId || 0).subscribe(result => {
            this.diurna = result;
            this.currencyList();
            this.countryList();
            this.diurnaTypeList();
    ...
    save() {
        this._diurnaService.saveDiurnaZi(this.diurna).subscribe(result => {
            this.notify.success("OKMessage");
            this.router.navigate(['/app/conta/nomenclatoare/diurna/diurnaPerZiList']);
        });
