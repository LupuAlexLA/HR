...
namespace Niva.Erp.Web.Host.Reports.Conta {
    ...
    public partial class RegistruJurnalExtinsReport : DevExpress.XtraReports.UI.XtraReport {
        private void InitializeComponent() {
            DevExpress.XtraReports.ReportInitializer reportInitializer = new DevExpress.XtraReports.ReportInitializer(this, "Niva.Erp.Web.Host.Reports.Conta.RegistruJurnalExtinsReport.vsrepx");
            ...
            this.GetCurrencies = reportInitializer.GetDataSource<DevExpress.DataAccess.ObjectBinding.ObjectDataSource>("GetCurrencies");
            this.GetCurrencies.DataSource = typeof(Niva.Erp.Web.Host.Reports.Conta.TestReportDataSource);
            this.GetDocumentType = reportInitializer.GetDataSource<DevExpress.DataAccess.ObjectBinding.ObjectDataSource>("GetDocumentType");
            this.GetDocumentType.DataSource = typeof(Niva.Erp.Web.Host.Reports.Conta.TestReportDataSource);
            this.GetOpStatus = reportInitializer.GetDataSource<DevExpress.DataAccess.ObjectBinding.ObjectDataSource>("GetOpStatus");
            this.GetOpStatus.DataSource = typeof(Niva.Erp.Web.Host.Reports.Conta.TestReportDataSource);
        ...
        private DevExpress.DataAccess.ObjectBinding.ObjectDataSource GetCurrencies;
        private DevExpress.XtraReports.Parameters.Parameter docTypeId;
        private DevExpress.DataAccess.ObjectBinding.ObjectDataSource GetDocumentType;
        private DevExpress.XtraReports.Parameters.Parameter opStatus;
        private DevExpress.DataAccess.ObjectBinding.ObjectDataSource GetOpStatus;
