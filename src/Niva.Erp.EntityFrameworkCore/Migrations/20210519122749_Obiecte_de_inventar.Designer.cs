...
namespace Niva.Erp.Migrations
{
    ...
    [Migration("20210519122749_Obiecte_de_inventar")]
    partial class Obiecte_de_inventar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Niva.Erp.Models.Contracts.InvoiceElementsDetails", b =>
                {
                    ...
                    b.Property<string>("ExpenseDirectAccount")
                        .HasColumnType("nvarchar(1000)")
                        .HasMaxLength(1000);
            ...
            modelBuilder.Entity("Niva.Erp.Models.InventoryObjects.InvCateg", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.InventoryObjects.InvObjectItem", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.InventoryObjects.InvStorage", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.InventoryObjects.InvObjectItem", b =>
                {
                    ...
                    b.HasOne("Niva.Erp.Models.InventoryObjects.InvCateg", "InvCateg")
                        .WithMany()
                        .HasForeignKey("InvCategId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Niva.Erp.Models.InventoryObjects.InvStorage", "InvStorage")
                        .WithMany()
