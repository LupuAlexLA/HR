...
namespace Niva.Erp.Migrations
{
    ...
    [Migration("20240428122037_AddNomenclatoare")]
    partial class AddNomenclatoare
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Niva.Erp.Models.Judet", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Masuratoare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.MasuratoareInterpretare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<int>("Culoare1")
                        .HasColumnType("int");

                    b.Property<int>("Culoare2")
                        .HasColumnType("int");

                    b.Property<string>("DescriereRezultat1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("DescriereRezultat2")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Expresie1")
                        .HasColumnType("nvarchar(max)");

                    b.Property<string>("Expresie2")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.HasIndex("MasuratoareId");

                    b.ToTable("MasuratoriInterpretari");
                });

            modelBuilder.Entity("Niva.Erp.Models.Studiu", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Tara", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Masuratoare", b =>
                {
                    b.HasOne("Niva.Erp.Models.Judet", "Judet")
                        .WithMany()
                        .HasForeignKey("JudetId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Niva.Erp.Authorization.Users.User", "Owner")
                        .WithMany()
                        .HasForeignKey("OwnerId");

                    b.HasOne("Niva.Erp.Models.Tara", "Tara")
                        .WithMany()
            ...
            modelBuilder.Entity("Niva.Erp.Models.MasuratoareInterpretare", b =>
                {
                    b.HasOne("Niva.Erp.Models.Masuratoare", "Masuratoare")
                        .WithMany()
                        .HasForeignKey("MasuratoareId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
