...
namespace Niva.Erp.Migrations
{
    ...
    [Migration("20200907125840_initial3")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Niva.Erp.Models.Conta.Bank", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Conta.ThirdParty", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Conta.Account", b =>
                {
                    ...
                    b.HasOne("Niva.Erp.Models.Conta.ThirdParty", "ThirdParty")
                        .WithMany()
            ...
            modelBuilder.Entity("Niva.Erp.Models.Conta.Bank", b =>
                {
                    b.HasOne("Niva.Erp.Models.Conta.LegalPerson", "LegalPerson")
                        .WithOne("Bank")
                        .HasForeignKey("Niva.Erp.Models.Conta.Bank", "LegalPersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Niva.Erp.Models.Conta.BankAccount", b =>
                {
                    b.HasOne("Niva.Erp.Models.Conta.Bank", "Bank")
                        .WithMany()
            ...
            modelBuilder.Entity("Niva.Erp.Models.Conta.ThirdParty", b =>
                {
                    b.HasOne("Niva.Erp.Models.Conta.Person", "Person")
                        .WithOne("ThirdParty")
                        .HasForeignKey("Niva.Erp.Models.Conta.ThirdParty", "PersonId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
