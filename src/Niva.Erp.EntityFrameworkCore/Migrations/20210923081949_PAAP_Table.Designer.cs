...
namespace Niva.Erp.Migrations
{
    ...
    [Migration("20210923081949_PAAP_Table")]
    partial class PAAP_Table
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.BVC_PAAP", b =>
                {
                    ...
                    b.Property<string>("ObiectTranzactie")
                        .HasColumnType("nvarchar(max)");

                    b.Property<int>("PaapId")
                        .HasColumnType("int");

                    b.Property<int>("State")
                        .HasColumnType("int");

                    b.Property<int>("SursaFinantareId")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.BVC_Planificare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<DateTime>("BVC_Date")
                        .HasColumnType("datetime2");

                    b.Property<int>("BVC_StructId")
                        .HasColumnType("int");

                    b.Property<DateTime>("BVC_Year")
                        .HasColumnType("datetime2");
                    ...
                    b.HasIndex("BVC_StructId");

                    b.ToTable("BVC_Planificare");
                });

            modelBuilder.Entity("Niva.Erp.Models.Buget.BVC_Struct", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.Property<string>("StructNumber")
                        .HasColumnType("nvarchar(max)");
                    ...
                    b.ToTable("BVC_Structs");
                });

            modelBuilder.Entity("Niva.Erp.Models.Buget.PAAP", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.PAAP_Stari", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
                    ...
                    b.ToTable("PAAP_Stari");
                });

            modelBuilder.Entity("Niva.Erp.Models.Buget.SursaFinantare", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.BVC_PAAP", b =>
                {
                    ...
                    b.HasOne("Niva.Erp.Models.Buget.PAAP", "Paap")
                        .WithMany("PAAP_Details")
                        .HasForeignKey("PaapId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Niva.Erp.Models.Buget.SursaFinantare", "SursaFinatare")
                        .WithMany()
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.BVC_Planificare", b =>
                {
                    b.HasOne("Niva.Erp.Models.Buget.BVC_Struct", "BVC_StructDetails")
                        .WithMany()
                        .HasForeignKey("BVC_StructId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
                });
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.BVC_Struct", b =>
                {
                    b.HasOne("Niva.Erp.Models.Buget.BVC_PAAP", "BVC_PAAP_Details")
                        .WithMany()
            ...
            modelBuilder.Entity("Niva.Erp.Models.Buget.PAAP_Stari", b =>
                {
                    b.HasOne("Niva.Erp.Models.Buget.PAAP", null)
                        .WithMany("PAAP_Stari")
                        .HasForeignKey("PAAPId");
                });
