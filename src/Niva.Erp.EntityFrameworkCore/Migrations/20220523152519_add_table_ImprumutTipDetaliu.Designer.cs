...
namespace Niva.Erp.Migrations
{
    ...
    [Migration("20220523152519_add_table_ImprumutTipDetaliu")]
    partial class add_table_ImprumutTipDetaliu
    {
            ...
            modelBuilder.Entity("Niva.Erp.Models.Imprumuturi.ImprumutTipDetaliu", b =>
                {
                    ...
                    b.HasOne("Niva.Erp.Models.Conta.Account", "ContImprumut")
                        .WithMany()
                        .HasForeignKey("ContImprumutId")
                        .OnDelete(DeleteBehavior.NoAction)
                        .IsRequired();
